...
namespace S2ObjectDefinitions.HPZ
{
    class Bridge : ObjectDefinition
    {
        ...
        {
            byte[] artfile = ObjectHelper.OpenArtFile("../art/nemesis/Bridge.bin", CompressionType.Nemesis);
            byte[] mapfile = System.IO.File.ReadAllBytes("../mappings/sprite/obj11_a.bin");
