SunsetHillTest_Header:
	smpsHeaderStartSong 1
	smpsHeaderVoice     SunsetHillTest_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $05

	smpsHeaderDAC       SunsetHillTest_DAC
	smpsHeaderFM        SunsetHillTest_FM1,	$F5, $13
	smpsHeaderFM        SunsetHillTest_FM2,	$01, $0B
	smpsHeaderFM        SunsetHillTest_FM3,	$F5, $15
	smpsHeaderFM        SunsetHillTest_FM4,	$F5, $09
	smpsHeaderFM        SunsetHillTest_FM5,	$F5, $21
	smpsHeaderPSG       SunsetHillTest_PSG1,	$D4, $05, $04, fTone_03
	smpsHeaderPSG       SunsetHillTest_PSG2,	$D4, $07, $04, fTone_06
	smpsHeaderPSG       SunsetHillTest_PSG3,	$04, $07, $04, fTone_04

; FM1 Data
SunsetHillTest_FM1:
	smpsSetvoice        $02
	smpsPan             panRight, $00
	smpsCall            SunsetHillTest_Call02
	smpsPan             panCenter, $00

SunsetHillTest_Loop0E:
	smpsPan             panLeft, $00
	dc.b	nE7, $04
	smpsPan             panRight, $00
	dc.b	nC7
	smpsAlterVol        $01
	smpsLoop            $00, $0D, SunsetHillTest_Loop0E
	dc.b	nE7, $04, nRst, $14
	smpsAlterVol        $EB
	smpsPan             panCenter, $00
	dc.b	nRst, $40, nRst, nRst, nRst, nRst, nRst

SunsetHillTest_Jump04:
	smpsSetvoice        $06
	smpsModSet          $0D, $01, $07, $04
	smpsAlterPitch      $F5 ; F4 > F5
	dc.b	nRst, $20
	smpsCall            SunsetHillTest_Call07
	dc.b	nC6, $38
	smpsCall            SunsetHillTest_Call07
	dc.b	nC6, $08, $08, nE6
	smpsAlterPitch      $0D ; 0C > 0D
	smpsSetvoice        $06
	smpsAlterPitch      $F5 ; F4 > F5
	...
	smpsNoteFill        $00
	smpsAlterVol        $F6
	smpsAlterPitch      $19 ; 18 > 19
	smpsJump            SunsetHillTest_Jump04

SunsetHillTest_Call02:
	dc.b	nA6, $04, nF6, nA6, nF6, nB6, nG6, nB6, nG6, nC7, nA6, nC7
	dc.b	nA6, nD7, nB6, nD7, nB6
	smpsReturn

SunsetHillTest_Call07:
...
SunsetHillTest_Loop0C:
	dc.b	nC3, $08
	smpsLoop            $00, $18, SunsetHillTest_Loop0C
	smpsNoteFill        $00
	dc.b	nC3, $04, nRst, nC3, $08, nA2, $04, nRst, nA2, $08, nBb2, $04
	dc.b	nRst, nBb2, $08, nB2, $04, nRst, nB2, $08
	smpsNoteFill        $04

SunsetHillTest_Loop0D:
	dc.b	nC3, $08
	smpsLoop            $00, $1D, SunsetHillTest_Loop0D
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3

SunsetHillTest_Jump03:
	smpsSetvoice        $01
	smpsCall            SunsetHillTest_Call05
	smpsCall            SunsetHillTest_Call06
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3
	smpsCall            SunsetHillTest_Call05
	smpsCall            SunsetHillTest_Call06
	...
	smpsNoteFill        $04
	smpsNop             $01
	smpsJump            SunsetHillTest_Jump03

SunsetHillTest_Call05:
	smpsNoteFill        $04
...
SunsetHillTest_FM3:
	...
	smpsSetvoice        $08
	smpsPan             panCenter, $00
	smpsAlterPitch      $E9 ; E8 > E9
	smpsAlterVol        $FE
	dc.b	nRst, $01

SunsetHillTest_Loop0A:
	dc.b	nC6, $01, smpsNoAttack, nB5, $0F, nRst, $08, nBb5, $01, smpsNoAttack, nA5, $0F
	dc.b	nRst, $08
	smpsLoop            $00, $02, SunsetHillTest_Loop0A
...
SunsetHillTest_Jump02:
	...
	smpsModOff
	smpsSetvoice        $05
	smpsCall            SunsetHillTest_Call04
	...
	smpsAlterVol        $FA
	smpsNoteFill        $00
	smpsJump            SunsetHillTest_Jump02

SunsetHillTest_Call03:
	dc.b	nRst, $34, nRst, nG6, $04, nA6, nC7, $08
	smpsReturn

SunsetHillTest_Call04:
	smpsAlterVol        $06
...
SunsetHillTest_Jump01:
	smpsSetvoice        $05
	smpsAlterPitch      $E9 ; E8 > E9
	smpsAlterVol        $18
	smpsPan             panLeft, $00
	smpsAlterVol        $FD
	smpsCall            SunsetHillTest_Call01
	...
	smpsAlterVol        $EE
	smpsNoteFill        $00
	smpsJump            SunsetHillTest_Jump01

SunsetHillTest_Call01:
...
SunsetHillTest_Loop04:
	dc.b	nBb6, $08, nF6, nD7, nF6, nBb6, nF6, nD7, nF6
	smpsLoop            $00, $02, SunsetHillTest_Loop04

SunsetHillTest_Loop05:
	dc.b	nA6, nE6, nC7, nE6, nA6, nE6, nC7, nE6
	smpsLoop            $00, $02, SunsetHillTest_Loop05

SunsetHillTest_Loop06:
	dc.b	nAb6, nEb6, nC7, nEb6, nAb6, nEb6, nC7, nEb6
	smpsLoop            $00, $02, SunsetHillTest_Loop06

SunsetHillTest_Loop07:
	dc.b	nC7, nA6, nE7, nA6, nC7, nA6, nE7, nA6
	smpsLoop            $00, $02, SunsetHillTest_Loop07
	smpsAlterVol        $0D
	smpsAlterPitch      $0D ; 0C > 0D
	smpsJump            SunsetHillTest_Jump00

SunsetHillTest_Call00:
	dc.b	nE5, $08, nE5, nC5, nC5, nA4, nA4, nF4, nF4, nD5, nD5, nB4
	dc.b	nB4, nG4, nG4
	smpsReturn
...
SunsetHillTest_Loop12:
	...
	smpsJump            SunsetHillTest_Loop13
...
SunsetHillTest_Jump05:
	dc.b	$08
	smpsJump            SunsetHillTest_Jump05

; DAC Data
SunsetHillTest_DAC:
	dc.b	nRst, $08, dKick, dSnare, dKick, dKick, dSnare, dSnare, dSnare

SunsetHillTest_Loop00:
	dc.b	dKick, $10, dSnare, $08, dKick, $10, $08, dSnare, $10
	smpsLoop            $00, $07, SunsetHillTest_Loop00
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08

SunsetHillTest_Loop01:
	dc.b	dKick, $10, dSnare, $08, dKick, $10, $08, dSnare, $10
	smpsLoop            $00, $07, SunsetHillTest_Loop01
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08
	smpsLoop            $01, $02, SunsetHillTest_Loop01
	smpsJump            SunsetHillTest_Loop01

SunsetHillTest_Voices:
;	Voice $00
;	$08
