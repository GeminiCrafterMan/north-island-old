EGHZ_Header:
	...
	smpsHeaderVoice     EGHZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $03

	smpsHeaderDAC       EGHZ_DAC
	smpsHeaderFM        EGHZ_FM1,	$F4, $12
	smpsHeaderFM        EGHZ_FM2,	$00, $0B
	smpsHeaderFM        EGHZ_FM3,	$F4, $14
	smpsHeaderFM        EGHZ_FM4,	$F4, $08
	smpsHeaderFM        EGHZ_FM5,	$F4, $20
	smpsHeaderPSG       EGHZ_PSG1,	$D0, $01, $00, fTone_03
	smpsHeaderPSG       EGHZ_PSG2,	$D0, $03, $00, fTone_06
	smpsHeaderPSG       EGHZ_PSG3,	$00, $03, $00, fTone_04

; FM1 Data
EGHZ_FM1:
	smpsSetvoice        $02
	smpsPan             panRight, $00
	smpsCall            EGHZ_Call02
...
EGHZ_Loop0D:
	dc.b	nC3, $08
	smpsLoop            $00, $1D, EGHZ_Loop0D
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3

EGHZ_Jump03:
	smpsSetvoice        $01
	smpsCall            EGHZ_Call05
	smpsCall            EGHZ_Call06
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3
	smpsCall            EGHZ_Call05
	smpsCall            EGHZ_Call06
...
EGHZ_Loop04:
	...
	smpsLoop            $00, $02, EGHZ_Loop04

EGHZ_Loop05:
	dc.b	nA6, nE6, nC7, nE6, nA6, nE6, nC7, nE6
	smpsLoop            $00, $02, EGHZ_Loop05

EGHZ_Loop06:
	dc.b	nAb6, nEb6, nC7, nEb6, nAb6, nEb6, nC7, nEb6
	smpsLoop            $00, $02, EGHZ_Loop06

EGHZ_Loop07:
	dc.b	nC7, nA6, nE7, nA6, nC7, nA6, nE7, nA6
	smpsLoop            $00, $02, EGHZ_Loop07
	smpsAlterVol        $0D
	smpsAlterPitch      $0C
	smpsJump            EGHZ_Jump00
...
EGHZ_Loop00:
	...
	smpsLoop            $00, $07, EGHZ_Loop00
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08

EGHZ_Loop01:
	dc.b	dKick, $10, dSnare, $08, dKick, $10, $08, dSnare, $10
	smpsLoop            $00, $07, EGHZ_Loop01
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08
	smpsLoop            $01, $02, EGHZ_Loop01
	smpsJump            EGHZ_Loop01
