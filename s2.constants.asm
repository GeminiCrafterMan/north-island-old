...
ObjID_WaiInvinc =		id(ObjPtr_WaiInvinc)		; 10
...
ObjID_PurpleRock =		id(ObjPtr_PurpleRock)
ObjID_BreakWall =		id(ObjPtr_BreakWall)		; 3C
...
ObjID_Batbot =			id(ObjPtr_Batbot)			; 4C (Beta enemy)
ObjID_BigRing =			id(ObjPtr_BigRing)
ObjID_BigRingFlash =	id(ObjPtr_BigRingFlash)
ObjID_Dinobot =			id(ObjPtr_Dinobot)			; 4F (Beta enemy)
...
ObjID_MetalCirno =		id(ObjPtr_MetalCirno)	; C4 ; Test object... for now.
...
ObjID_Snailer	=			id(ObjPtr_Snailer)			; D0 (Beta enemy)
;ObjID_IceCube	=			id(ObjPtr_IceCube)
...
AniIDSonAni_Victory		= id(SonAni_Victory_ptr)		; 19 ; $13
...
AniIDSonAni_Dummy		= id(SonAni_Dummy_ptr)		; 29 ; $1D
AniIDSonAni_Dummy2		= id(SonAni_Dummy2_ptr)		; 30 ; $1E
AniIDSupSonAni_Transform	= id(SupSonAni_Transform_ptr)	; 31 ; $1F
AniIDSonAni_Continue		= id(SonAni_Continue_ptr)		; 32 ; $20
...
AniIDTailsAni_Victory		= id(TailsAni_Victory_ptr)		; 19 ; $13
...
AniIDTailsAni_Balance2		= id(TailsAni_Balance2_ptr)		; 29 ; $1D
AniIDTailsAni_Dummy5		= id(TailsAni_Dummy5_ptr)		; 30 ; $1E
AniIDTailsAni_HaulAss		= id(TailsAni_HaulAss_ptr)		; 31 ; $1F
AniIDTailsAni_FlyFast           = id(TailsAni_FlyFast_ptr)              ; 32 ; $20
AniIDTailsAni_Fly		= id(TailsAni_Fly_ptr)	                ; 33 ; $21
AniIDTailsAni_FlyTired		= id(TailsAni_FlyTired_ptr)		; 34 ; $22
AniIDTailsAni_Swim		= id(TailsAni_Swim_ptr)		        ; 35 ; $23
AniIDTailsAni_SwimTired	        = id(TailsAni_SwimTired_ptr)	        ; 36 ; $24
AniIDTailsAni_Swim2		= id(TailsAni_Swim2_ptr)		; 37 ; $25
AniIDTailsAni_Transform	        = id(TailsAni_Transform_ptr)	        ; 38 ; $26
AniIDTailsAni_CarryUp	        = id(TailsAni_CarryUp_ptr)	        ; 39 ; $27
AniIDTailsAni_Carry	        = id(TailsAni_Carry_ptr)	        ; 40 ; $28
AniIDTailsAni_SwimCarryTired	= id(TailsAni_SwimCarryTired_ptr)	; 41 ; $29
...
;idstart :=	0
;
;AniIDKnucklesAni_Walk		= id(KnucklesAni_Walk_ptr)			;  0 ;   0
;AniIDKnucklesAni_Run		= id(KnucklesAni_Run_ptr)			;  1 ;   1
;AniIDKnucklesAni_Roll		= id(KnucklesAni_Roll_ptr)			;  2 ;   2
;AniIDKnucklesAni_Roll2		= id(KnucklesAni_Roll2_ptr)		;  3 ;   3
;AniIDKnucklesAni_Push		= id(KnucklesAni_Push_ptr)		        ;  4 ;   4
;AniIDKnucklesAni_Wait		= id(KnucklesAni_Wait_ptr)			;  5 ;   5
;AniIDKnucklesAni_Balance		= id(KnucklesAni_Balance_ptr)		;  6 ;   6
;AniIDKnucklesAni_LookUp		= id(KnucklesAni_LookUp_ptr)		;  7 ;   7
;AniIDKnucklesAni_Duck		= id(KnucklesAni_Duck_ptr)			;  8 ;   8
;AniIDKnucklesAni_Spindash		= id(KnucklesAni_Spindash_ptr)		;  9 ;   9
;AniIDKnucklesAni_Unused		= id(KnucklesAni_Unused_ptr)		; 10 ;  $A
;AniIDKnucklesAni_Pull		= id(KnucklesAni_Pull_ptr)		; 11 ;  $B
;AniIDKnucklesAni_Balance2		= id(KnucklesAni_Balance2_ptr)		; 12 ;  $C
;AniIDKnucklesAni_Stop		= id(KnucklesAni_Stop_ptr)		        ; 13 ;  $D
;AniIDKnucklesAni_Float		= id(KnucklesAni_Float_ptr)		; 14 ;  $E
;AniIDKnucklesAni_Float2		= id(KnucklesAni_Float2_ptr)		; 15 ;  $F
;AniIDKnucklesAni_Spring		= id(KnucklesAni_Spring_ptr)		; 16 ; $10
;AniIDKnucklesAni_Hang		= id(KnucklesAni_Hang_ptr)		        ; 17 ; $11
;AniIDKnucklesAni_Unused_0		= id(KnucklesAni_Unused_0_ptr)		; 18 ; $12
;AniIDKnucklesAni_S3EndingPose		= id(KnucklesAni_S3EndingPose_ptr)		; 19 ; $13
;AniIDKnucklesAni_Hang2		= id(KnucklesAni_Hang2_ptr)		; 20 ; $14
;AniIDKnucklesAni_Bubble		= id(KnucklesAni_Bubble_ptr)		; 21 ; $15
;AniIDKnucklesAni_DeathBW		= id(KnucklesAni_DeathBW_ptr)		; 22 ; $16
;AniIDKnucklesAni_Drown		= id(KnucklesAni_Drown_ptr)		; 23 ; $17
;AniIDKnucklesAni_Death		= id(KnucklesAni_Death_ptr)		; 24 ; $18
;AniIDKnucklesAni_Hurt		= id(KnucklesAni_Hurt_ptr)			; 25 ; $19
;AniIDKnucklesAni_Hurt2		= id(KnucklesAni_Hurt2_ptr)		; 26 ; $1A
;AniIDKnucklesAni_Slide		= id(KnucklesAni_Slide_ptr)		; 27 ; $1B
;AniIDKnucklesAni_Blank		= id(KnucklesAni_Blank_ptr)		; 28 ; $1C
;AniIDKnucklesAni_Balance2		= id(KnucklesAni_Balance2_ptr)		; 29 ; $1D
;AniIDKnucklesAni_Dummy5		= id(KnucklesAni_Dummy5_ptr)		; 30 ; $1E
...
Misc_Variables:
			ds.w	1	; palette_frame, but for tails
...
S1_Col_flag:		ds.b	1	; S1 collision flag
...
Demo_button_index:		ds.w	1	; F790 index into button press demo data, for player 1
Demo_press_counter:		ds.b	1	; F792 frames remaining until next button press, for player 1
				ds.b	1	; $FFFFF793 ; seems unused
PalChangeSpeed:			ds.w	1	; F794-F795
...
BigRingGraphics:	ds.w	1	; S1 holdover
				ds.b	5	; $FFFFF7C0-$FFFFF7C4 ; seems unused
Flying_carrying_Sonic_flag:     ds.b    1       ; $FFFFF7C5 ; used in tails grabbing
Reverse_gravity_flag:    ds.b 1                 ; $FFFFF7C6 ; used in tails flight
...
AirMove_Performed:				ds.b	1	; $FFFFFF8D ; Thok
...
CD_Sounds_flag:	ds.b	1	; $FFFFFFE0
				ds.b	$F	; $FFFFFFE1-$FFFFFFEF ; seems unused
...
ArtTile_Nem_SSBgFish				  = $0051
ArtTile_Nem_SSWalls					  = $0142
ArtTile_Nem_Bumper					  = $023B
ArtTile_Nem_SSGOAL					  = $0251
ArtTile_Nem_SSUpDown				  = $0263
ArtTile_Nem_SSRBlock				  = $02F0
ArtTile_Nem_SS1UpBlock				  = $0370
ArtTile_Nem_SSEmStars				  = $03F0
ArtTile_Nem_SSRedWhite				  = $0470
ArtTile_Nem_SSGhost					  = $04F0
ArtTile_Nem_SSWBlock				  = $0570
ArtTile_Nem_SSGlass					  = $05F0
ArtTile_Nem_SSEmerald				  = $0770
ArtTile_Nem_SSZone14				  = $0797
ArtTile_Nem_SSZone25				  = $07A0
ArtTile_Nem_SSZone36				  = $07A9
ArtTile_Nem_S1SSRing				  = $07B2
...
ArtTile_Art_GhzFlower2				  = $036C
ArtTile_ArtNem_EndPoints              = $04B6
ArtTile_ArtNem_GHZ_Purple_Rock        = $0527
ArtTile_ArtNem_GHZ_WallBarrier		  = $034C
ArtTile_ArtNem_Crabmeat_SYZ           = $053F
