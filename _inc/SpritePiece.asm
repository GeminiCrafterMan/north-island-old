...
dplcEntry macro tiles,offset
	...
	dplcEntry	tiles-(((dplcTiles+(offset*$20)+(tiles*$20))#131072)/$20),offset
	dplcEntry	((dplcTiles+(offset*$20)+(tiles*$20))#131072)/$20,offset+(tiles-(((dplcTiles+(offset*$20)+(tiles*$20))#131072)/$20))
	exitm
	endif
	endif
...
s3kPlayerDplcEntry macro tiles,offset
	if dplcTiles <> 0
	if ((dplcTiles+(offset*$20))/131072) <> ((dplcTiles+(offset*$20)+(tiles*$20)-1)/131072)
	s3kPlayerDplcEntry	tiles-(((dplcTiles+(offset*$20)+(tiles*$20))#131072)/$20),offset
	s3kPlayerDplcEntry	((dplcTiles+(offset*$20)+(tiles*$20))#131072)/$20,offset+(tiles-(((dplcTiles+(offset*$20)+(tiles*$20))#131072)/$20))
	exitm
	endif
	endif
	dc.w	(((tiles-1)&$F)<<12)|(offset&$FFF)
